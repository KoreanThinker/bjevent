...
const itemUrl = ['http://www.bhc.co.kr//upload/bhc/menu//410_0024_%ED%95%B4%EB%B0%94%EB%9D%BC%EA%B8%B0%20%ED%9B%84%EB%9D%BC%EC%9D%B4%EB%93%9C%20%EC%B9%98%ED%82%A8(2).jpg', 'http://www.bhc.co.kr//upload/bhc/menu//410_0020_%EB%A7%A4%EC%9A%B4%EC%96%91%EB%85%90%EC%B9%98%ED%82%A8(1).jpg'];
const itemName = ['BHC 후라이드', 'BHC 양념'];
const moreUrl = ['http://www.bhc.co.kr//upload/bhc/menu//410_0024_%ED%95%B4%EB%B0%94%EB%9D%BC%EA%B8%B0%20%ED%9B%84%EB%9D%BC%EC%9D%B4%EB%93%9C%20%EC%B9%98%ED%82%A8(2).jpg', 'http://www.bhc.co.kr//upload/bhc/menu//410_0020_%EB%A7%A4%EC%9A%B4%EC%96%91%EB%85%90%EC%B9%98%ED%82%A8(1).jpg'];
    ...
    render() {
        return (
            <div style={{ width: '100vw', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#222', flexDirection: 'column' }}>
                ...
                <FiShare2 size='22px' color='white' style={{ margin: 20, alignSelf: 'center' }} />
